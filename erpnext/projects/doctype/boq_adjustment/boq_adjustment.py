...
class BOQAdjustment(Document):
	...
	if TYPE_CHECKING:
		from erpnext.projects.doctype.boq_adjustment_item.boq_adjustment_item import BOQAdjustmentItem
		from frappe.types import DF

		adjustment_date: DF.Date
		amended_from: DF.Link | None
		boq: DF.Link | None
		boq_date: DF.Date
		boq_item: DF.Table[BOQAdjustmentItem]
